  ...
  return knex('categories').del()
    .then(function () {
      return Promise.all([
        ...
        knex('categories').insert({label: 'Category 1', user_id: 4}),
        knex('categories').insert({label: 'Category 2', user_id: 4}),
        knex('categories').insert({label: 'Category 3', user_id: 4}),
        knex('categories').insert({label: 'Category 4', user_id: 4}),
        knex('categories').insert({label: 'Category 5', user_id: 4}),
      ]);
    });
};
